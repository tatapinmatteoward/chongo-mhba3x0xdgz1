...
export const metadata: Metadata = {
  ...
  description: "A simple blog sharing guides on diagnosing and resolving the most common errors in personal computers, from software glitches to hardware hiccups.",
};
